...
Code from https://github.com/facebookresearch/ConvNeXt, copyright below.
# Copyright (c) Meta Platforms, Inc. and affiliates.
# All rights reserved.
# This source code is licensed under the MIT license

Maybe look at the timm implementation:
...
class Block(nn.Module):
    ...
    """
    def __init__(self, dim: int, drop_path=0., layer_scale_init_value=1e-6):
        super().__init__()
...
class ConvNeXt(nn.Module):
    ...
    def __init__(self,
        ...
        out_indices = out_indices if out_indices else [0, 1, 2, 3]
