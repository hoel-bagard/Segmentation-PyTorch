...
class DangerResNet50(nn.Module):
    def __init__(self, output_classes: int, max_danger_level: int, finetune: bool = True, **kwargs):
        """Instanciate a network with a pretrained resnet50 as feature extractor.
        ...
        resnet = models.segmentation.fcn_resnet50(pretrained=True).backbone  # Pretrained on COCO.
